...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-additional-fields', __webpack_require__(5));
  Vue.component('detail-additional-fields', __webpack_require__(8));
  Vue.component('form-additional-fields', __webpack_require__(12));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_AdditionalFieldsDisplay__ = __webpack_require__(10);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_AdditionalFieldsDisplay__["a" /* default */]],
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: {
        ...
        summaryTextNumber: function summaryTextNumber() {
            return this.field.value ? Object.keys(this.fields).length : 0;
        },
        summaryTextLabel: function summaryTextLabel() {
            return this.field.summary_label ? this.field.summary_label : 'fields';
        },
        ...
        _vm._l(_vm.fields, function(value, key) {
          return _c("li", [
            _c("ul", { staticClass: "list-reset mb-4" }, [
              _c("li", { staticClass: "flex items-top mb-1" }, [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DateField__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DateField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__DateField__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        DateField: __WEBPACK_IMPORTED_MODULE_1__DateField___default.a
    },
    ...
    computed: {
        ...
        endpoint: function endpoint() {
            return this.field.endpoint.replace('{resource-name}', this.resourceName).replace('{resource-id}', this.resourceId ? this.resourceId : '').replace('{' + this.field.parent_value + '}', this.parentValue ? this.parentValue : '');
        }
    },
    ...
    methods: {
        ...
        isWatchingComponent: function isWatchingComponent(component) {
            return component.field !== undefined && component.field.attribute === this.field.parent_value;
        },
    ...
    [
      _c(
        ...
        [
          _vm.fields.length === 0
            ? _c("div", [
                _vm._v("Choose a category to find it's relevant fields")
              ])
            : _vm._e(),
          _vm._v(" "),
            ...
            return _c("div", { staticClass: "flex border-b border-40" }, [
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.deleteRow(item.text)
                    }
                  }
                },
                [
                ...
                ? _c("div", { staticClass: "py-6 px-8 w-full" }, [
                    ...
                    (item.type === "number" || item.type === "text")
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.inputs[item.text],
                              expression: "inputs[item.text]"
                            }
                          ],
                          staticClass:
                            "w-full form-control form-input form-input-bordered",
                          attrs: { placeholder: item.text, type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(_vm.inputs[item.text])
                              ? _vm._i(_vm.inputs[item.text], null) > -1
                              : _vm.inputs[item.text]
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.inputs[item.text],
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                _vm.$set(_vm.inputs, item.text, $$c)
                              }
                            }
                          }
                        })
                      ...
                      ? _c("input", {
                          ...
                          staticClass:
                            "w-full form-control form-input form-input-bordered",
                          attrs: { placeholder: item.text, type: "radio" },
                          domProps: {
                            checked: _vm._q(_vm.inputs[item.text], null)
                          },
                          on: {
                            change: function($event) {
                              return _vm.$set(_vm.inputs, item.text, null)
                            }
                          }
                        })
                      : item.type === "number" || item.type === "text"
                      ? _c("input", {
                          ...
                          staticClass:
                            "w-full form-control form-input form-input-bordered",
                          attrs: { placeholder: item.text, type: item.type },
                          domProps: { value: _vm.inputs[item.text] },
                          on: {
              ...
              item.type === "select"
                ? _c(
                    "div",
                    { staticClass: "flex flex-wrap ml-8" },
                    _vm._l(item.options, function(option) {
                      return _c(
                        "label",
                        { staticClass: "flex items-center select-none mr-2" },
                        [
                          _c("input", {
                            directives: [
                              {
                            ...
                            staticClass: "checkbox mr-1",
                            attrs: { type: "checkbox" },
                            domProps: {
                              checked: Array.isArray(_vm.inputs[option])
                                ? _vm._i(_vm.inputs[option], null) > -1
                                : _vm.inputs[option]
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.inputs[option],
                                  $$el = $event.target,
                                  $$c = $$el.checked ? true : false
                                if (Array.isArray($$a)) {
                                  var $$v = null,
